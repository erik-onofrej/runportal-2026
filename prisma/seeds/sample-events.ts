...
async function seedSampleEvents() {
  ...
  const runningClub = await prisma.organizer.upsert({
    ...
    create: {
      ...
      logo: 'https://ui-avatars.com/api/?name=Bratislava+Running+Club&size=200&background=3B82F6&color=fff',
      isActive: true,
    },
  });
  ...
  const marathonOrg = await prisma.organizer.upsert({
    ...
    create: {
      ...
      logo: 'https://ui-avatars.com/api/?name=Slovak+Marathon&size=200&background=EF4444&color=fff',
      isActive: true,
    },
  });
  ...
  const trailOrg = await prisma.organizer.upsert({
    ...
    create: {
      ...
      logo: 'https://ui-avatars.com/api/?name=Trail+Runners&size=200&background=10B981&color=fff',
      isActive: true,
    },
  });
  ...
  const cityRunOrg = await prisma.organizer.upsert({
    ...
    create: {
      ...
      logo: 'https://ui-avatars.com/api/?name=City+Run&size=200&background=8B5CF6&color=fff',
      isActive: true,
    },
  });
  ...
  const autumnTrail = await prisma.event.upsert({
    ...
    create: {
      ...
      coverImage: 'https://images.unsplash.com/photo-1551632811-561732d1e306?w=1200&h=600&fit=crop',
      status: 'completed',
  ...
  const nightRun = await prisma.event.upsert({
    ...
    create: {
      ...
      coverImage: 'https://images.unsplash.com/photo-1513593771513-7b58b6c4af38?w=1200&h=600&fit=crop',
      status: 'completed',
  ...
  const springHalf = await prisma.event.upsert({
    ...
    create: {
      ...
      coverImage: 'https://images.unsplash.com/photo-1571008887538-b36bb32f4571?w=1200&h=600&fit=crop',
      status: 'published',
  ...
  const springMarathon = await prisma.event.upsert({
    ...
    create: {
      ...
      coverImage: 'https://images.unsplash.com/photo-1532444458054-01a7dd3e9fca?w=1200&h=600&fit=crop',
      status: 'published',
  ...
  const parkRun = await prisma.event.upsert({
    ...
    create: {
      ...
      coverImage: 'https://images.unsplash.com/photo-1502904550040-7534597429ae?w=1200&h=600&fit=crop',
      status: 'published',
  ...
  const castleClimb = await prisma.event.upsert({
    ...
    create: {
      ...
      coverImage: 'https://images.unsplash.com/photo-1483721310020-03333e577078?w=1200&h=600&fit=crop',
      status: 'published',
  ...
  const riversideRun = await prisma.event.upsert({
    ...
    create: {
      ...
      coverImage: 'https://images.unsplash.com/photo-1551958219-acbc608c6377?w=1200&h=600&fit=crop',
      status: 'published',
  ...
  const oldTownCircuit = await prisma.event.upsert({
    ...
    create: {
      ...
      coverImage: 'https://images.unsplash.com/photo-1472740378865-80aab8e73251?w=1200&h=600&fit=crop',
      status: 'published',
